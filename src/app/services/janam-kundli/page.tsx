            ...
            <div className="max-w-3xl space-y-6">
              ...
              >
                ...
                <p className="text-base sm:text-lg md:text-xl text-[#F8F3EA]/90 font-medium leading-relaxed max-w-2xl drop-shadow">
                  Generate your authentic Vedic birth chart (Kundli) with exact Lagna, Moon Rashi,
                  Nakshatra, planetary positions, D9 Navamsha, and lifetime Dasha predictions.
                </p>
              </motion.div>
            ...
            <div className="lg:col-span-7 glass-card border border-[#B88A44]/30 rounded-3xl p-6 sm:p-8 space-y-6 shadow-2xl">
              <div className="space-y-1">
                ...
                <p className="text-xs sm:text-sm text-[#6B5E55]">
                  Accurate birth parameters unlock exact Lagna, Nakshatra & Dasha predictions
                </p>
              </div>
            ...
            <div className="lg:col-span-5 space-y-4">
                  ...
                  <li className="flex items-start gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[#6B5E55] text-xs mt-0.5">
                        Exact planetary house placements, signs & exact degrees.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[#6B5E55] text-xs mt-0.5">
                        Crucial divisional chart revealing spouse & second-half life destiny.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[#6B5E55] text-xs mt-0.5">
                        Detailed current Mahadasha, Antardasha & timeline forecasts.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[#6B5E55] text-xs mt-0.5">
                        In-depth evaluations of Manglik, Sade Sati & Kaal Sarp Yogas.
                      </p>
                    </div>
                  </li>
                </ul>
              ...
              <div className="p-5 rounded-2xl bg-gradient-to-br from-[#281123] to-[#170b16] text-white border border-[#B88A44]/30 space-y-2.5 shadow-xl">
                ...
                <p className="text-xs text-[#F8F3EA]/90 leading-relaxed">
                  Have a certified Vedic Astrologer review your birth chart live for career,
                  marriage, or financial decisions.
                </p>
                <Link
