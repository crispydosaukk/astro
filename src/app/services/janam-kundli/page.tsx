...
export default function FreeJanamKundliPage() {
  ...
  return (
    <div className="min-h-screen bg-background dark text-foreground">
      ...
      <section className="relative overflow-hidden border-b border-[#B88A44]/20 flex flex-col justify-center min-h-[85vh] lg:min-h-[90vh] pt-24 lg:pt-28 pb-16 lg:pb-24">
        ...
        <div className="absolute inset-0 z-0 select-none pointer-events-none">
          <Image
            ...
            alt="Vedic Janam Kundli Background"
            fill
            className="object-cover object-center lg:object-right scale-100"
            priority
          />
          {/* Targeted overlays: dark gradient on left for crisp readability, open on right for vivid zodiac mandala */}
        ...
        <div className="absolute bottom-1/3 right-1/4 w-96 h-96 rounded-full bg-[#C9952B]/20 blur-3xl pointer-events-none z-0" />
            ...
            <div className="max-w-3xl space-y-6">
              ...
              >
                <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs sm:text-sm font-bold tracking-wide bg-[#B88A44]/20 text-[#F6D075] border border-[#B88A44]/40 shadow-xl shadow-black/20 backdrop-blur-md">
                  ...
                  Free Authentic Vedic Janam Kundli
                </span>
              </motion.div>
              ...
              >
                ...
                <p className="text-base sm:text-lg md:text-xl text-[#F8F3EA]/90 font-medium leading-relaxed max-w-2xl drop-shadow">
                  Generate your authentic Vedic birth chart (Kundli) with exact Lagna, Moon Rashi, Nakshatra, planetary positions, D9 Navamsha, and lifetime Dasha predictions.
                </p>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2.5 px-4 py-2.5 rounded-2xl bg-black/45 border border-white/15 backdrop-blur-md shadow-lg">
                  ...
                  <span className="text-xs sm:text-sm font-semibold text-white/95">100% Accurate Vedic Math</span>
                </div>
                <div className="flex items-center gap-2.5 px-4 py-2.5 rounded-2xl bg-black/45 border border-white/15 backdrop-blur-md shadow-lg">
                  <Sun size={16} className="text-[#F6D075]" />
                  <span className="text-xs sm:text-sm font-semibold text-white/95">Lagna & D9 Navamsha</span>
                </div>
                <div className="flex items-center gap-2.5 px-4 py-2.5 rounded-2xl bg-black/45 border border-white/15 backdrop-blur-md shadow-lg">
                  <Compass size={16} className="text-[#F6D075]" />
                  <span className="text-xs sm:text-sm font-semibold text-white/95">Vimshottari Dasha Analysis</span>
                </div>
              </motion.div>
              ...
              >
                ...
                >
                  Check Your Kundli <ArrowRight size={18} />
                </button>
                <Link
                  href="/services/horoscope/love"
                  className="px-5 py-3.5 rounded-full bg-rose-500/20 border border-rose-500/40 text-rose-100 font-bold hover:bg-rose-500/30 hover:scale-[1.02] transition-all flex items-center gap-2 text-xs sm:text-sm backdrop-blur-md shadow-md"
                >
                  <Heart size={15} className="text-rose-400" /> Love
                </Link>
                <Link
                  href="/services/horoscope/finance"
                  className="px-5 py-3.5 rounded-full bg-emerald-500/20 border border-emerald-500/40 text-emerald-100 font-bold hover:bg-emerald-500/30 hover:scale-[1.02] transition-all flex items-center gap-2 text-xs sm:text-sm backdrop-blur-md shadow-md"
                >
                  <Coins size={15} className="text-emerald-400" /> Finance
                </Link>
                <Link
                  href="/services/horoscope/health"
                  className="px-5 py-3.5 rounded-full bg-cyan-500/20 border border-cyan-500/40 text-cyan-100 font-bold hover:bg-cyan-500/30 hover:scale-[1.02] transition-all flex items-center gap-2 text-xs sm:text-sm backdrop-blur-md shadow-md"
                >
                  <Activity size={15} className="text-cyan-400" /> Health
                </Link>
              </motion.div>
            </div>
          </div>
      ...
      {/* Input Form Section */}
      <section id="form-section" className="py-12 lg:py-16 bg-background relative z-10">
            ...
            <div className="lg:col-span-7 glass-card border border-[#B88A44]/30 rounded-3xl p-6 sm:p-8 space-y-6 shadow-2xl">
              <div className="space-y-1">
                <span className="text-xs font-bold text-[#713B32] uppercase tracking-widest bg-[#EDE4D5] px-3 py-1 rounded-full border border-[#E5D9C8] inline-block">
                  New Kundli Generation
                </span>
                <h2 className="text-2xl sm:text-3xl font-bold text-[#292522] pt-1">Enter Birth Details</h2>
                <p className="text-xs sm:text-sm text-[#6B5E55]">Accurate birth parameters unlock exact Lagna, Nakshatra & Dasha predictions</p>
              </div>
              ...
              <form onSubmit={handleCalculate} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-[#FFFDFC] border border-[#E5D9C8] focus:border-[#B88A44] focus:ring-2 focus:ring-[#B88A44]/20 text-[#292522] placeholder:text-[#6B5E55]/60 text-sm outline-none shadow-sm transition-all"
                  />
                </div>

                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-[#713B32] uppercase tracking-wider flex items-center gap-1.5">
                    <User size={14} className="text-[#B88A44]" /> Gender*
                  </label>
                  <select
                    value={formData.gender}
                    onChange={(e) => setFormData({ ...formData, gender: e.target.value })}
                    className="w-full px-4 py-3 rounded-xl bg-[#FFFDFC] border border-[#E5D9C8] focus:border-[#B88A44] focus:ring-2 focus:ring-[#B88A44]/20 text-[#292522] text-sm outline-none shadow-sm transition-all cursor-pointer"
                  >
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-[#713B32] uppercase tracking-wider flex items-center gap-1.5">
                    <Calendar size={14} className="text-[#B88A44]" /> Birth Date*
                  </label>
                  <input
                    type="date"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-[#713B32] uppercase tracking-wider flex items-center gap-1.5">
                    <Clock size={14} className="text-[#B88A44]" /> Birth Time*
                  </label>
                  <input
                    type="time"
                    required
                ...
                <div className="sm:col-span-2 pt-2">
                  ...
                  >
                    <Sparkles size={18} />
                    <span>{isCalculating ? 'Generating AI Kundli Report...' : 'Generate Free Janam Kundli'}</span>
                  </button>
                </div>
              </form>
            </div>
            ...
            <div className="lg:col-span-5 space-y-4">
              <div className="glass-card border border-[#B88A44]/20 rounded-3xl p-6 sm:p-7 space-y-4 shadow-lg">
                <div className="flex items-center gap-2 text-[#713B32] font-bold text-sm">
                  ...
                  <span>What Your Free Kundli Includes</span>
                </div>
                ...
                <ul className="space-y-3 text-xs sm:text-sm text-[#292522]">
                  <li className="flex items-start gap-2.5">
                    ...
                    <div>
                      <strong className="text-[#713B32]">Lagna Chart (D1) & Moon Chart</strong>
                      <p className="text-[#6B5E55] text-xs mt-0.5">Exact planetary house placements, signs & exact degrees.</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <span className="w-5 h-5 rounded-full bg-[#B88A44]/20 text-[#713B32] font-bold flex items-center justify-center flex-shrink-0 text-xs mt-0.5">✓</span>
                    <div>
                      <strong className="text-[#713B32]">D9 Navamsha Chart</strong>
                      <p className="text-[#6B5E55] text-xs mt-0.5">Crucial divisional chart revealing spouse & second-half life destiny.</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <span className="w-5 h-5 rounded-full bg-[#B88A44]/20 text-[#713B32] font-bold flex items-center justify-center flex-shrink-0 text-xs mt-0.5">✓</span>
                    <div>
                      <strong className="text-[#713B32]">Vimshottari Dasha Analysis</strong>
                      <p className="text-[#6B5E55] text-xs mt-0.5">Detailed current Mahadasha, Antardasha & timeline forecasts.</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <span className="w-5 h-5 rounded-full bg-[#B88A44]/20 text-[#713B32] font-bold flex items-center justify-center flex-shrink-0 text-xs mt-0.5">✓</span>
                    <div>
                      <strong className="text-[#713B32]">Manglik & Planetary Dosha Checks</strong>
                      <p className="text-[#6B5E55] text-xs mt-0.5">In-depth evaluations of Manglik, Sade Sati & Kaal Sarp Yogas.</p>
                    </div>
                  </li>
                </ul>
                ...
                <div className="pt-2 border-t border-[#E5D9C8] flex items-center justify-between text-xs text-[#6B5E55]">
                  <span className="flex items-center gap-1 font-semibold text-[#713B32]">
                    <ShieldCheck size={14} className="text-emerald-600" /> 100% Private & Free
                  </span>
                  <span>Vedic Astronomical Math</span>
                </div>
              </div>

              {/* Quick Astrologer CTA */}
              <div className="p-5 rounded-2xl bg-gradient-to-br from-[#281123] to-[#170b16] text-white border border-[#B88A44]/30 space-y-2.5 shadow-xl">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-[#F6D075] uppercase tracking-wider">Need Personal Guidance?</span>
                  <span className="px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-300 text-[10px] font-bold">Online Now</span>
                </div>
                <p className="text-xs text-[#F8F3EA]/90 leading-relaxed">
                  Have a certified Vedic Astrologer review your birth chart live for career, marriage, or financial decisions.
                </p>
                <Link
        ...
        {horoscopeReport && (
          <section id="report-section" className="py-10 bg-background/50 border-t border-white/5 space-y-8">
            <div className="max-w-screen-2xl mx-auto px-6 lg:px-10 space-y-6">
              ...
              <DynamicPageContent pageId="janam-kundli" />
