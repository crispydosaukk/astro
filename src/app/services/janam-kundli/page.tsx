              ...
              >
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-3 pt-4">
                    ...
                    >
                      Check Your Kundli <ArrowRight size={16} />
                    </button>
                    <Link
                    ...
                    >
                      <Heart size={13} className="text-rose-400" /> Love
                    </Link>
                    <Link
                    ...
                    >
                      <Coins size={13} className="text-emerald-400" /> Finance
                    </Link>
                    <Link
                    ...
                    >
                      <Activity size={13} className="text-cyan-400" /> Health
                    </Link>
                  </div>
                </div>
              </motion.div>
        ...
        <div className="max-w-screen-2xl mx-auto px-6 lg:px-10">
          <div className="glass-card border border-white/10 rounded-3xl p-6 sm:p-10 space-y-6 shadow-xl">
            <div className="text-center space-y-1">
              ...
              <p className="text-xs text-muted-foreground">Accurate birth parameters unlock exact Lagna, Nakshatra & Dasha predictions</p>
            </div>
