          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-white/70 mb-8 leading-relaxed">
                Fasting is one of the most powerful Vedic remedies. Get a personalized fasting
                calendar aligned with your birth chart, complete with food guides and spiritual
                practices.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-foreground mb-6">
                Benefits of <span className="text-gradient-gold">Vedic Fasting</span>
              </h2>
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-[#C9952B]/20 flex items-center justify-center text-xs font-bold text-[#C9952B]">
                        {item?.date}
                      </div>
                      <div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-screen-xl mx-auto px-6 lg:px-10">
          <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
            Popular <span className="text-gradient-gold">Vedic Fasts</span>
          </h2>
      ...
      <section className="py-16 cosmic-bg">
        <div className="max-w-screen-xl mx-auto px-6 lg:px-10 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Start Your <span className="text-gradient-gold">Fasting Journey</span>
          </h2>
          <p className="text-white/60 mb-8 max-w-xl mx-auto">
            Get your personalized fasting calendar with monthly reminders, food guides, and
            spiritual practices.
          </p>
