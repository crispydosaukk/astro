              ...
              >
                <div>
                  ...
                  <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4 tracking-tight leading-tight max-w-xl">
                    Free Online <br />
                    <span className="text-gradient-gold">Janam Kundli</span>
                  </h1>
                  <p className="text-sm sm:text-base text-muted-foreground leading-relaxed max-w-lg">
                    Generate your free Vedic birth chart (Kundli) with Lagna, Rashi, Nakshatra, planetary positions, and future predictions.
                  </p>
                  ...
                  <div className="flex flex-wrap items-center gap-4 pt-4">
                    ...
                    <Link
                      ...
                      className="px-6 py-3.5 rounded-full bg-white/5 border border-white/10 text-foreground font-semibold hover:bg-white/10 transition-colors backdrop-blur-sm flex items-center gap-2 text-xs sm:text-sm"
                    >
                      Daily Horoscope →
                    </Link>
                  </div>
            ...
            <div className="max-w-6xl mx-auto px-6 space-y-6">
              ...
              <div className="glass-card p-6 sm:p-8 rounded-3xl border border-white/10 flex flex-wrap items-center justify-between gap-6 shadow-2xl">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <button
                    onClick={handlePrint}
                    className="px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-foreground font-semibold hover:bg-white/10 transition-colors flex items-center gap-2 text-xs"
                  >
                    <Printer size={14} className="text-[#C9952B]" /> Print / PDF
                  </button>
                </div>
              </div>
              ...
              {activeTab === 'predictions' && (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="glass-card p-6 rounded-3xl border border-white/10 space-y-2">
                    <h4 className="font-bold text-emerald-400 text-base">💰 Finance & Wealth</h4>
                    <p className="text-xs text-muted-foreground leading-relaxed">{horoscopeReport.predictions.finance}</p>
                  </div>
                  <div className="glass-card p-6 rounded-3xl border border-white/10 space-y-2">
                    <h4 className="font-bold text-rose-400 text-base">❤️ Marriage & Relationships</h4>
                    <p className="text-xs text-muted-foreground leading-relaxed">{horoscopeReport.predictions.marriage}</p>
                  </div>
                  <div className="glass-card p-6 rounded-3xl border border-white/10 space-y-2">
                    <h4 className="font-bold text-blue-400 text-base">🌿 Health & Vitality</h4>
