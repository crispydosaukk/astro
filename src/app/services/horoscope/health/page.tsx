  ...
  return (
    <div className="min-h-screen bg-background dark text-foreground">
      ...
      <section className="relative overflow-hidden border-b border-white/5 flex flex-col pt-28 lg:pt-36 pb-16 lg:pb-20 cosmic-bg">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-cyan-500/15 blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 max-w-screen-2xl mx-auto px-6 lg:px-10 w-full">
          <div className="grid lg:grid-cols-12 items-start gap-8 lg:gap-12 w-full">
            ...
            >
              <div>
                <span className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-semibold bg-cyan-500/10 text-cyan-300 border border-cyan-500/20 mb-4 backdrop-blur-md">
                  <Activity size={14} className="text-cyan-400" /> Vedic Health & Vitality Horoscope
                </span>
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-3 tracking-tight leading-tight max-w-xl">
                  Nurture Your <br />
                  <span className="text-gradient-gold">Vedic Health & Vitality</span>
                </h1>
              ...
              {/* Form Card */}
              <div className="glass-card p-6 sm:p-8 rounded-3xl border border-cyan-500/20 shadow-2xl backdrop-blur-xl bg-card/80 space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        className="w-full px-4 py-2.5 rounded-2xl bg-white/5 border border-white/10 text-foreground text-sm focus:outline-none focus:border-[#C9952B] transition-colors"
                      >
                        <option value="Immunity, Stamina & Energy" className="bg-background">Immunity, Stamina & Energy</option>
                        <option value="Stress, Anxiety & Mental Peace" className="bg-background">Stress & Mental Tranquility</option>
                        <option value="Digestive Health & Metabolism" className="bg-background">Digestive Agni & Metabolism</option>
                        <option value="Longevity & Rejuvenation" className="bg-background">Longevity & Rejuvenation</option>
                      </select>
                    </div>
                  </div>
                  ...
                  >
                    {isCalculating ? (
                      <>
                        ...
                        Analyzing Ayur-Jyotish Placements...
                      </>
                    ) : (
                      <>
                        <Sparkles size={16} /> Generate Free Health Horoscope
                      </>
                    )}
                  </button>
                </form>
