...
export default function IshtaDevataServicePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
              ...
              <div className="space-y-3">
                <div className="p-4 rounded-xl bg-[#C9952B]/10 border border-[#C9952B]/20">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Moon in 12th house with Ketu aspect
                  </p>
                </div>
      ...
      {/* NEW DETAILED DEVATĀ WORSHIP SECTION */}
      ...
      <section className="py-16 cosmic-bg">
        <div className="max-w-screen-2xl mx-auto px-6 lg:px-10 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Discover Your <span className="text-gradient-gold">Divine Connection</span>
          </h2>
          <p className="text-white/60 mb-8 max-w-xl mx-auto">
            Get your complete Ishta Devata report with daily worship guide, stotra recommendations,
            and temple suggestions.
          </p>
