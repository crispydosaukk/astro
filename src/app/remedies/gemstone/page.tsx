    ...
    <div className="min-h-screen bg-background">
            ...
            <span className="text-[#C9952B]">Gemstone Advice</span>
              ...
              >
                <div className="relative w-full h-full max-w-lg lg:max-w-xl">
                  <Image
                    src={homepageContent?.services.items.find(s => s.id === 'svc-gemstone')?.image || '/assets/images/remedies/remedies_gemstone_1785738400359.png'}
                    alt="Gemstone Advice"
                    fill
            ...
            <div className="grid grid-cols-3 gap-3">
              {content.gemstones.slice(0, 6).map((g, i) => (
                <motion.div
                  ...
                  className={`rounded-2xl p-4 ${g?.bg} border border-border text-center`}
                >
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-2xl mx-auto px-6 lg:px-10">
          <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
            {content.faqTitle.split(' ').map((word, i, arr) =>
              i === arr.length - 1 ? (
                <span key={i} className="text-gradient-gold">
                  {word}
                </span>
      ...
      <section className="py-16 cosmic-bg">
        <div className="max-w-screen-xl mx-auto px-6 lg:px-10 text-center">
          ...
          <p className="text-white/60 mb-8 max-w-xl mx-auto">
            Consult with our expert astrologers for a personalized gemstone recommendation backed by
