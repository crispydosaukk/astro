            ...
            <div className="grid lg:grid-cols-2 items-center min-h-screen">
              ...
              >
                <div className="relative w-full h-full max-w-lg lg:max-w-xl">
                  <Image
                    src={homepageContent?.services.items.find(s => s.id === 'svc-homam')?.image || '/assets/images/remedies/remedies_homam_1785738443734.png'}
                    alt="Homam & Puja"
                    fill
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-foreground mb-6">
                {content.benefitsTitle.split(' ').map((word, i, arr) =>
                  i === arr.length - 1 ? (
              ...
              <div className="space-y-3">
                <div className="p-4 rounded-xl bg-[#C9952B]/10 border border-[#C9952B]/20">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Saturday · 6:00–9:00 AM · 3–4 hours
                  </p>
                </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-screen-2xl mx-auto px-6 lg:px-10">
          <h2 className="text-3xl font-bold text-foreground mb-8 text-center">
            {content.homamsTitle.split(' ').map((word, i, arr) =>
      ...
      <section className="py-16 cosmic-bg">
        <div className="max-w-screen-2xl mx-auto px-6 lg:px-10 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Get Your <span className="text-gradient-gold">Homam Recommendation</span>
          </h2>
          <p className="text-white/60 mb-8 max-w-xl mx-auto">
            Receive a detailed Homam recommendation with auspicious timing, materials list, and
