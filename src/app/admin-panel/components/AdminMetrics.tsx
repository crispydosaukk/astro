      ...
      {dynamicMetrics.map((m, i) => {
        ...
        return (
          ...
          >
            ...
            <div
              className={`w-10 h-10 rounded-xl ${m?.bg} flex items-center justify-center mb-3 icon-hover-animate`}
            >
            ...
            {m?.trend && (
              <div
                className={`flex items-center gap-1 text-xs font-medium mt-2 ${m?.up ? 'text-green-400' : 'text-red-400'}`}
              >
