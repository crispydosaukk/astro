      ...
      <div className="p-6 border-b border-border flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            Arjun Sharma · 15 Mar 1992, 06:30 AM · Mumbai
          </p>
        </div>
        <div className="flex items-center gap-2">
          <button
            className="p-2 rounded-xl hover:bg-muted transition-all icon-hover-animate"
          ...
          <Link
            href="/#services"
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold gold-gradient-bg text-white"
          >
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border">
                <th className="text-left py-2 text-xs font-500 text-muted-foreground uppercase tracking-wide">
                  Planet
                </th>
                <th className="text-left py-2 text-xs font-500 text-muted-foreground uppercase tracking-wide">
                  Position
            ...
            <tbody>
              {planets?.map((planet, i) => (
                ...
                >
                  ...
                  <td className="py-2.5">
                    <span className={`text-xs font-semibold ${planet?.statusColor}`}>
                      {planet?.status}
                    </span>
                  </td>
                </motion.tr>
